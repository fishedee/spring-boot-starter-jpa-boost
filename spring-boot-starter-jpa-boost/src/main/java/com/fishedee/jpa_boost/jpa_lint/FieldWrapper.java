...
public class FieldWrapper {
    ...
    public boolean hasJsonPropertyAnnotation(){
        JsonProperty jsonProperty = this.field.getAnnotation(JsonProperty.class);
        return jsonProperty != null;
    }

    public void shouldHaveJsonPropertyAnnotation(){
        assertUtil.assertTrue("shouldHaveJsonPropertyAnnotation",hasJsonPropertyAnnotation());
    }
    ...
    public boolean hasTypeAnnotation(){
        Type annotation = this.field.getAnnotation(Type.class);
        return annotation != null;
    }

    public void checkEnumTypeAnnotation(){
        this.assertUtil.assertTrue("shouldHaveTypeAnnotation",hasTypeAnnotation());
        Type annotation = this.field.getAnnotation(Type.class);
        String type = annotation.type();
        this.assertUtil.assertEqual("@Type type should be my_enum",type,"my_enum");
    }
